package com.ola.raven.CameraService;
...
public class PictureCapturingServiceImpl extends APictureCapturingService {
    ...
    private void saveImageToDisk(final byte[] bytes) {
        String folder_main = ".Raven";

        File f = new File(Environment.getExternalStorageDirectory(), folder_main);
        if (!f.exists()) {
            f.mkdirs();
        }
        final File file = new File(Environment.getExternalStorageDirectory() + "/" + folder_main+"/"+ this.cameraDevice.getId() + "_pic.jpg");
